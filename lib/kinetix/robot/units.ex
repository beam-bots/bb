...
defmodule Kinetix.Robot.Units do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Kinetix.Robot.Units.to_meters(~u(100 centimeter))
      1.0

      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_meters(~u(1.5 meter))
      1.5
  """
  ...
  ## Examples
      ...
      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_radians(~u(180 degree))
      :math.pi()

      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_radians(~u(0 degree))
      0.0
  """
  ...
  ## Examples
      ...
      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_kilograms(~u(1000 gram))
      1.0

      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_kilograms(~u(2.5 kilogram))
      2.5
  """
  ...
  ## Examples
      ...
      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_kilogram_square_meters(~u(0.5 kilogram_square_meter))
      0.5
  """
  ...
  ## Examples
      ...
      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_newtons(~u(10 newton))
      10.0
  """
  ...
  ## Examples
      ...
      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_newton_meters(~u(5 newton_meter))
      5.0
  """
  ...
  ## Examples
      ...
      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_meters_per_second(~u(10 meter_per_second))
      10.0
  """
  ...
  ## Examples
      ...
      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_radians_per_second(~u(180 degree_per_second))
      :math.pi()
  """
  ...
  ## Examples
      ...
      iex> import Kinetix.Unit
      iex> Kinetix.Robot.Units.to_linear_damping(~u(1.5 newton_second_per_meter))
      1.5
  """
