...
defmodule Kinetix.Message.Vec3 do
  ...
  ## Examples
      ...
      iex> alias Kinetix.Message.Vec3
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.new(1, 2, 3)
      {:vec3, 1.0, 2.0, 3.0}

      iex> Kinetix.Message.Vec3.new(1.5, 2.5, 3.5)
      {:vec3, 1.5, 2.5, 3.5}
  """
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.unit_x()
      {:vec3, 1.0, 0.0, 0.0}
  """
  @spec unit_x() :: t()
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.unit_y()
      {:vec3, 0.0, 1.0, 0.0}
  """
  @spec unit_y() :: t()
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.unit_z()
      {:vec3, 0.0, 0.0, 1.0}
  """
  @spec unit_z() :: t()
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.x({:vec3, 1.0, 2.0, 3.0})
      1.0
  """
  @spec x(t()) :: float()
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.y({:vec3, 1.0, 2.0, 3.0})
      2.0
  """
  @spec y(t()) :: float()
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.z({:vec3, 1.0, 2.0, 3.0})
      3.0
  """
  @spec z(t()) :: float()
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.to_list({:vec3, 1.0, 2.0, 3.0})
      [1.0, 2.0, 3.0]
  """
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Vec3.from_list([1.0, 2.0, 3.0])
      {:vec3, 1.0, 2.0, 3.0}
  """
