defmodule Kinetix.Message.Option do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Option.vec3_type()
      {:custom, Kinetix.Message.Option, :validate_vec3, [[]]}
  """
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Option.quaternion_type()
      {:custom, Kinetix.Message.Option, :validate_quaternion, [[]]}
  """
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Option.validate_vec3({:vec3, 1.0, 2.0, 3.0}, [])
      {:ok, {:vec3, 1.0, 2.0, 3.0}}

      iex> Kinetix.Message.Option.validate_vec3({:vec3, 1, 2, 3}, [])
      {:error, "expected {:vec3, x, y, z} with float values, got: {:vec3, 1, 2, 3}"}

      iex> Kinetix.Message.Option.validate_vec3("not a vec3", [])
  ...
  ## Examples
      ...
      iex> Kinetix.Message.Option.validate_quaternion({:quaternion, 0.0, 0.0, 0.0, 1.0}, [])
      {:ok, {:quaternion, 0.0, 0.0, 0.0, 1.0}}

      iex> Kinetix.Message.Option.validate_quaternion({:quaternion, 0, 0, 0, 1}, [])
