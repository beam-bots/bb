...
defmodule Kinetix.Urdf.Exporter do
  @moduledoc """
  Export a Kinetix robot definition to URDF XML format.
  """

  alias Kinetix.Robot
  alias Kinetix.Robot.{Joint, Link}
  alias Kinetix.Urdf.Xml

  @doc """
  Export a robot module to URDF XML string.

  The module must use `Kinetix` and have a `robot/0` function.
  """
  ...
  defp get_robot(module) do
    if function_exported?(module, :robot, 0) do
      ...
      {:error, {:not_a_kinetix_module, module}}
    end
  end
