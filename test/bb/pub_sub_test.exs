...
defmodule BB.PubSubTest do
  ...
  describe "subscribe/3 and publish/3" do
    ...
    test "subscriber to empty path receives all messages" do
      ...
      assert_receive {:bb, ^sensor_path, ^sensor_msg}
      assert_receive {:bb, ^actuator_path, ^actuator_msg}
    end
    ...
    test "multiple subscribers receive the same message" do
      ...
      spawn_link(fn ->
        ...
        receive do
          {:bb, ^path, msg} -> send(test_pid, {:subscriber1, msg})
        end
      end)
      ...
      spawn_link(fn ->
        ...
        receive do
          {:bb, ^path, msg} -> send(test_pid, {:subscriber2, msg})
        end
      end)
  ...
  describe "message type filtering" do
    test "subscriber with message_types filter only receives matching types" do
      ...
      refute_receive {:bb, ^pose_path, _}, 50
    end
    ...
    test "subscriber without message_types filter receives all types" do
      ...
      assert_receive {:bb, ^imu_path, ^imu_msg}
      assert_receive {:bb, ^pose_path, ^pose_msg}
    end
