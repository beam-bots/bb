...
defmodule Kinetix.Test.ImmediateSuccessCommand do
  ...
  @impl true
  def handle_execute(_robot_state, state), do: {:succeeded, :done, state}

  @impl true
  def handle_cancel(_robot_state, state), do: {:canceled, :stopped, state}

  @impl true
  def handle_info(_msg, _robot_state, state), do: {:executing, state}
end
...
defmodule Kinetix.Test.AsyncCommand do
  ...
  @impl true
  def handle_execute(_robot_state, state) do
  ...
  @impl true
  def handle_info(:complete, _robot_state, state), do: {:succeeded, :completed, state}
  def handle_info(:abort, _robot_state, state), do: {:aborted, :failed, state}
  def handle_info(_msg, _robot_state, state), do: {:executing, state}
end
...
defmodule Kinetix.Test.RejectingCommand do
  ...
  @impl true
  def handle_execute(_robot_state, state), do: {:executing, state}
