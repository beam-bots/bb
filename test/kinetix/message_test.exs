defmodule Kinetix.MessageTest do
  use ExUnit.Case, async: true

  alias Kinetix.Message
  alias Kinetix.Message.Geometry.{Accel, Pose, Transform, Twist, Wrench}
  alias Kinetix.Message.{Quaternion, Vec3}
  alias Kinetix.Message.Sensor.{BatteryState, Image, Imu, JointState, LaserScan, Range}
